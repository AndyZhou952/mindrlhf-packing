...
class SPMDGPUExecutor(ExecutorBase):
    ...
    def __init__(
        ...
        self._init_executor(distributed_init_method)

    def _init_executor(self, distributed_init_method) -> None:
    ...
    def initialize_cache(self, num_gpu_blocks: int, num_cpu_blocks: int) -> None:
        ...
        # have GPUs.
        print(f"# NPU blocks: {num_gpu_blocks}, # CPU blocks: {num_cpu_blocks}", flush=True)

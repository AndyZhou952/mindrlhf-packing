...
# from mindspore_verl.workers.rollout.tokenizer import HybridEngineBaseTokenizer
...
class LLM(LLM):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.llm_engine = LLMEngine.from_engine_args(tokenizer, engine_args)  # TODO: check usagecontext
    ...
    def get_model(self):
        return self.llm_engine.get_model()

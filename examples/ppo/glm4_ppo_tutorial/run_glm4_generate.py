...
def main(sft_path, reward_path, critic_path, use_parallel, enable_compile_cache, only_save_strategy,
    ...
    enable_compile_cache = transfer_from_str_to_bool(enable_compile_cache)
    only_save_strategy = transfer_from_str_to_bool(only_save_strategy)
    ...
    if load_sft_checkpoint == "None":
        ...
        load_sft_checkpoint = ckpt_transfer_for_two_stages(load_sft_checkpoint)
    ...
    if load_ref_checkpoint == "None":
        load_ref_checkpoint = None
    ...
    if load_rm_checkpoint == "None":
        load_rm_checkpoint = None
    rm_config.load_checkpoint = load_rm_checkpoint
    ...
    if load_critic_checkpoint == "None":
        load_critic_checkpoint = None
